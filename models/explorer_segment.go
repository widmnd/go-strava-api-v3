...
func (m *ExplorerSegment) validateClimbCategory(formats strfmt.Registry) error {
	...
	if err := validate.MinimumInt("climb_category", "body", int64(*m.ClimbCategory), 0, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("climb_category", "body", int64(*m.ClimbCategory), 5, false); err != nil {
		return err
	}
