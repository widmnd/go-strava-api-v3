...
func (m *DetailedSegmentEffort) validateKomRank(formats strfmt.Registry) error {
	...
	if err := validate.MinimumInt("kom_rank", "body", int64(m.KomRank), 1, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("kom_rank", "body", int64(m.KomRank), 10, false); err != nil {
		return err
	}
...
func (m *DetailedSegmentEffort) validatePrRank(formats strfmt.Registry) error {
	...
	if err := validate.MinimumInt("pr_rank", "body", int64(m.PrRank), 1, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("pr_rank", "body", int64(m.PrRank), 3, false); err != nil {
		return err
	}
