...
type ClientService interface {
	GetEffortsBySegmentID(params *GetEffortsBySegmentIDParams, authInfo runtime.ClientAuthInfoWriter) (*GetEffortsBySegmentIDOK, error)

	GetSegmentEffortByID(params *GetSegmentEffortByIDParams, authInfo runtime.ClientAuthInfoWriter) (*GetSegmentEffortByIDOK, error)
...
*/
func (a *Client) GetEffortsBySegmentID(params *GetEffortsBySegmentIDParams, authInfo runtime.ClientAuthInfoWriter) (*GetEffortsBySegmentIDOK, error) {
...
*/
func (a *Client) GetSegmentEffortByID(params *GetSegmentEffortByIDParams, authInfo runtime.ClientAuthInfoWriter) (*GetSegmentEffortByIDOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
