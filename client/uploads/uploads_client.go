...
type ClientService interface {
	CreateUpload(params *CreateUploadParams, authInfo runtime.ClientAuthInfoWriter) (*CreateUploadCreated, error)

	GetUploadByID(params *GetUploadByIDParams, authInfo runtime.ClientAuthInfoWriter) (*GetUploadByIDOK, error)
